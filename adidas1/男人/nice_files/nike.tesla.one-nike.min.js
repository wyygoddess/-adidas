...
nike.cq.define("nike.cq.honey.plugins.SlideContainsVideo",[],function(){var a;
return{name:"slideContainsVideo",initCarousel:function(b){a=b.data("controller");
...
},showSlide:function(d,g,f){var e=d.find("video"),c=g.find("video"),h=Boolean(c.length),b=c.closest("div").data("controls");
...
nike.cq.require(["nike.cq.PES.Tracking","nike.cq.Tracking"],function(a,b){a.extend((function(u,f,h,t){var j="p1";
function q(w){var x={};
var y="teamselector:change team:";
y+=u(w.el.find("option:selected"));
x.prop3=y;
return x
}function k(w){var x={};
if(typeof(w.el)!=="object"){return x
}var y=w.el.find("img").attr("data-tracking");
x.prop3="P1 auto rotate:color chip selection:"+y;
return x
}function v(w){return w.data("slide-index")
}function d(w){return w.closest(".indexed-pes-reference").data("pes-reference-index")
}function g(w){var x=w.closest(".nike-cq-p1-layout-foreground"),y=x.find(".nike-cq-subtitle:first");
return u(y)
}function i(w){return w.closest(".nike-cq-p1-layout").find(".nike-cq-p1-layout-background img")
}function o(y){var w="";
if(y){var z=y.data("hotspotTitle");
var x=y.data("hotspotDescription");
if(z&&z!==""){w=z
}else{if(x&&x!==""){w=x
}}}return w
}function l(F){if(typeof F.el==="undefined"){return{}
}var E=F.el.parent(),y=F.el.hasClass("active"),D=o(E),B=F.el.closest(".nike-cq-carousel-slide"),z=B.length>0,x=y?"close":"open",A={};
if(z){var C=v(B),w=g(F.el);
A.prop3="p1 carousel "+C+":"+w+":hotspots:"+x+":"+f(D)
}else{A.prop3="p1 hotspots:"+x+":"+f(D)
}return A
}function m(C){if(typeof C.el==="undefined"){return{}
}var B=C.el.parent(),x=C.el.hasClass("active"),A=o(B),E=C.el.closest(".nike-cq-carousel"),z=E.length>0,w=C.el.attr("href"),y={};
y.prop3="p1 hidden hotspots:image:"+w;
var D=t(i(C.el),j);
if(D){y.eVar5=D
}return y
}function c(E){if(typeof E.el==="undefined"){return{}
}var D=E.el.closest(".hotspot"),C=o(D),x=u(E.el),A=E.el.closest(".nike-cq-carousel-slide"),y=A.length>0,z={};
if(y){var B=v(A),w=g(E.el);
z.prop3="p1 carousel "+B+":"+w+":hotspots:click:"+f(C)+":"+x
}else{z.prop3="p1 hotspots:click:"+f(C)+":"+x
}var F=t(i(E.el),j);
if(F){z.eVar5=F
}return z
}function s(w){var y={};
if(typeof w.el==="undefined"){return y
}var x=u(w.el);
y.prop3="p1 toggle:load:"+x;
return y
}function r(L){if(typeof L.el==="undefined"||L.el.attr("href")==="#"){return{}
}var y=h(L.el),G=L.el.closest(".nike-cq-carousel-slide"),D=G.length>0,w=undefined,K=L.el.closest(".nike-cq-p1-layout-foreground").find(".nike-cq-hotspot-type-invisible"),A=K.length>0,B=L.el.closest(".nike-cq-p1").find(".nike-cq-video-bg"),I=B.length>0,F=L.el.closest(".nike-cq-tout-toggle-container"),x=F.length>0,E={};
if(D){w=v(G);
var z=g(L.el);
E.prop3="p1 carousel "+w+":"+z+":"+y
}else{if(I){E.prop3="p1 animation:"+y
}else{if(A){E.prop3="p1 hidden hotspots:cta:"+y
}else{if(x){F=L.el.closest(".nike-cq-toggle");
var C=F.find(".nike-cq-toggle-component .is-selected");
var J=u(C);
var H=$(".device-type-phone").size()>0;
if(H){E.prop3=j+":"+y
}else{E.prop3="p1 toggle:click:"+J+":"+y
}}else{E.prop3=j+":"+y
}}}}var M=t(i(L.el),j);
if(M){E.eVar5=M
}return E
}function n(x){if(typeof x.el==="undefined"){return{}
}var z=x.el.siblings("a").data("tracking");
var w=x.el.find("option:selected").text(),y={};
if(x.el.find("option:selected").attr("value")==="#"){return{}
}else{y.prop3=j+":"+z+">"+w
}return y
}function p(E){var A={};
if(typeof E.el==="undefined"){return A
}var B=E.el.closest(".nike-cq-carousel-slide"),z=B.length>0,y=E.el.closest(".nike-cq-p1").find(".nike-cq-video-bg"),A={};
var D=E.el.closest(".nike-cq-p1-layout-component ").find(".nike-cq-p1-layout-background img").attr("alt");
var w=E.el.closest(".nike-cq-p1-layout-component ");
if(z){var C=v(B),x=g(E.el);
A.prop3="p1 carousel:"+C+":"+D+":image"
}else{if(y.length>0){A.prop3="p1:video:"+D+":image"
}else{A.prop3=j+":"+D+":image"
}}var F=t(i(w),j);
if(F){A.eVar5=F
}return A
}function e(y){var z={};
if(typeof y.el==="undefined"){return z
}var x=y.el.attr("href");
if(y.data&&y.data.prop3){z.prop3=b.replaceValues(y.data.prop3,x)
}else{z.prop3=x
}var w=t(y.el.closest(".nike-cq-product-wall-header").find(".nike-cq-product-wall-header-section-1 img"),"product wall header");
if(w){z.eVar5=w
}return z
}return{productOptionsProcessor:k,p1HotspotsProcessor:l,p1HotspotsCtaProcessor:c,p1InvisibleHotspotsProcessor:m,p1ToggleProcessor:s,p1CtaProcessor:r,p1PhoneStackedCtaProcessor:n,teamSelectorMobileProcessor:q,p1ImageAnchorProcessor:p,pwhAnchorProcessor:e}
...
nike.cq.require(["jquery","nike.cq.PES.Tracking","nike.cq.Tracking"],function(b,a,c){a.extend((function(k,z,A,g,i,w){function t(N){var H={},Q="fst";
var J=N.el;
var K=J.attr("data-tracking");
var G=J.closest(".nike-cq-block-component-wrap");
var I=G.attr("data-row-position");
var M=G.attr("data-column-position");
I++;
M++;
var L=G.closest(".nike-cq-fst-component");
var E=e(L);
if(L.hasClass("nike-cq-fst-with-video")){Q+=":video"
}var D=L.closest(".indexed-pes-reference");
if(D.length>0){var P=D.attr("data-pes-reference-index");
H.prop3=Q+":"+P+":"+E+":row"+I+"col"+M+":"+K
}else{var F=L.closest(".nike-cq-carousel-slide");
if(F.length===0){H.prop3=Q+":"+E+":row"+I+"col"+M+":"+K
}else{var P=F.attr("data-slide-index");
H.prop3=Q+":"+P+":"+E+":row"+I+"col"+M+":"+K
}}var O=w(u(L),"fst");
if(O){H.eVar5=O
}return H
}function e(H){var G="";
if(H.hasClass("nike-cq-fst-with-video")){var F=H.find(".nike-cq-fst-background-video .nike-cq-fst-video-bg-component");
var E=F.attr("data-video-url")||"";
G=E?E.substring(E.lastIndexOf("/")+1):H.find(".nike-cq-fst-background-image img").attr("alt")
}else{var D=H.find(".nike-cq-fst-background-image img");
G=D.attr("alt")
}return G
}function u(D){return D.find(".nike-cq-fst-background-image img")
}function B(F){var G={};
var E=i(F.el);
var H=F.el.closest(".nike-cq-fst-component");
var J=u(H);
var I=J.attr("alt");
G.prop3="fst:label:"+I+":"+E;
var D=w(J,"fst");
if(D){G.eVar5=D
}return G
}function o(E){var F={};
if(typeof(E.el)=="undefined"){return F
}var D=x(E);
F.prop3="fst:label:"+D;
return F
}function j(L){if(typeof L.el==="undefined"){return{}
}var E=L.el.closest(".nike-cq-full-screen-container"),D=L.el.closest(".hotspot"),I=L.el.hasClass("active"),H=I?"close":"open",G="fst",K=r(D),J=C(D),F=q(D);
if(H!=="open"){return{}
}return{prop3:G+":"+H+":"+K+":"+J+":"+g(F)}
}function n(L){if(typeof L.el==="undefined"){return{}
}var E=L.el.closest(".nike-cq-full-screen-container"),D=L.el.closest(".hotspot"),H="fst",F=A(L.el),K=r(L.el),I=C(D),G=(q(D)||m(D));
var J={};
J.prop3=H+":cta:"+g(F)+":"+K+":"+I+":"+g(G);
var M=w(u(E),"fst");
if(M){J.eVar5=M
}return J
}function s(K){if(typeof K.el==="undefined"){return{}
}var E=K.el.closest(".nike-cq-full-screen-container"),D=K.el.closest(".hotspot"),G="fst",J=r(D),H=C(D),F=(q(D)||m(D));
var I={};
I.prop3=G+":click:"+J+":"+H+":"+g(F);
var L=w(u(E),"fst");
if(L){I.eVar5=L
}return I
}function v(K){if(typeof K.el==="undefined"){return{}
}var E=K.el.closest(".nike-cq-full-screen-container"),D=K.el.closest(".hotspot"),G="fst",J=r(D),H=C(D),F=(q(D)||m(D));
var I={};
I.prop3=G+":click:"+J+":"+H+":"+g(F);
var L=w(u(E),"fst");
...
}var D=b(F.el).parent().data("id"),H=b(F.el).closest(".nike-cq-tout-toggle-container").find("[data-pes-reference-index="+D+"]"),E=f(H);
G.prop3="fst:slide change:"+D+":"+E;
return G
}function l(F){if(typeof F.el==="undefined"){return{}
}if(F.el[0]&&!b(F.el[0]).hasClass("paused")){return{events:"event55"}
}var E=b(F.el).closest(".nike-cq-fst-background-video");
var D=y(E);
return{prop18:"fst:"+D,eVar47:"fst:"+D,events:"event55"}
}function d(L){if(typeof L.el==="undefined"){return{}
}var N=L.el.siblings("a").data("tracking");
var J,I,O;
I=L.el.closest(".nike-cq-carousel-slide");
var E=L.el.data("tracking-target-index");
if(!E){return{}
}var H=L.el.closest(".nike-cq-fst"),K=H.find(".nike-cq-fst-background-video"),G=L.el.children().eq(E),D=G.text().trim(),F={};
L.el.data("tracking-target-index",undefined);
if(G.attr("value")==="#"){return{}
}if(I.length>0){J=I.attr("data-slide-index");
O=I.find(".nike-cq-image img").attr("alt");
F.prop3="fst:"+J+":"+O+":"+N+">"+D
}else{if(K.length>0){F.prop3="fst:video:"+N+">"+D
}else{F.prop3="fst:"+N+">"+D
}}var M=w(u(H),"fst");
if(M){F.eVar5=M
}return F
}function h(K){var F={};
if(typeof K.el==="undefined"){return F
}var I=K.el.closest(".nike-cq-fst-component"),G=I.find(".nike-cq-fst-background-video").length>0,D="fst:"+(G?"video:":""),E=I.closest(".nike-cq-carousel-slide"),J=E.length>0?E.attr("data-slide-index")+":":"",H=u(I).attr("alt");
F.prop3=D+J+H+":image";
var L=w(u(I),"fst");
if(L){F.eVar5=L
}return F
}function y(D){var F=D.find("source");
if(F&&F[0]){var E=F[0].src;
return E.substring(E.lastIndexOf("/")+1)
}return""
}function x(D){var E,G,F;
G=D.el.closest(".nike-cq-carousel-slide");
if(G.length>0){E=G.attr("data-slide-index");
F=f(G)
}return E+":"+F+":"+i(D.el)
}function f(E){var K=A(E.find(".nike-cq-block-title")),G=A(E.find(".nike-cq-block-subtitle")),I=E.find(".nike-cq-image-component"),D=I.attr("alt"),J=I.attr("src"),H;
if(K.length){var F=[K];
...
}function r(E){var D=b(E).closest(".hotspot-system").data("hotspot-type").replace("hotspot-type-","");
if(D=="crosshair"){D="benefit"
}else{if(D=="invisible"){D="hidden"
}}return D+" hotspot"
}function m(D){return D.data("hotspot-link-0-url")
}function C(E){var D=b(E).attr("id").replace("hotspot","");
return parseInt(D)+1
}function q(D){return b(D).data("hotspot-title")||[b(D).data("hotspot-title1"),b(D).data("hotspot-title2")].join(" ").trim()||b(D).find(".nike-cq-hotspots-title").text()
}return{fstCTAProcessor:t,fstLabelProcessor:B,fstCarouselImageLabelProcessor:o,fstHotspotsProcessor:j,fstHotspotsCtaProcessor:n,fstInvisibleHotspotsProcessor:s,fstShopHotspotsProcessor:v,fstToggleProcessor:p,fstVideoPlayControlProcessor:l,fstAnchorProcessor:h,fstPhoneStackedCtaProcessor:d}
